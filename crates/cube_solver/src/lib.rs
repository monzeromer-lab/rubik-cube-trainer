...
//! - [`five`] — 5×5 reduction-based solver for already-reduced inputs
//!   (no parity quirks; full IDA* reduction is M15 polish).
...
pub use five::{Solve5x5Error, Solver5x5};
pub use four::{PLL_PARITY_ALG, Solve4x4Error, Solver4x4};
